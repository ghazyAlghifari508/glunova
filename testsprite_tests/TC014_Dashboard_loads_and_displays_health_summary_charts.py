...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login using the explicit navigate action as required by the test step.
        await page.goto("http://localhost:3000/login")
        
        # -> Type the username into the email field, type the password into the password field, then click the 'Masuk Dashboard' (submit) button to attempt login.
        frame = context.pages[-1]
        # Input text
