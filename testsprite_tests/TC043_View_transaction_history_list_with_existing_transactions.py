...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Masuk' button to open the login form (element index 14).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/main/div/div/nav/div[3]/a/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Type username and password into the login form and click 'Masuk Dashboard' (submit) to attempt login.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Open the user/profile menu to reveal the 'Riwayat Transaksi' (Transaction History) item and click it.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/main/div/div/nav/div[3]/div/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Riwayat Transaksi' (Transaction History) menu item to open the Transaction History page (use element index 1931).
        frame = context.pages[-1]
        # Click element
