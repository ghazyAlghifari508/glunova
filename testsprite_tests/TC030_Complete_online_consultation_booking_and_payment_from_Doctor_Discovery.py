...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (http://localhost:3000/login) as the test step explicitly requires using the navigate action.
        await page.goto("http://localhost:3000/login")
        
        # -> Type the username into the email field (input index 1381).
